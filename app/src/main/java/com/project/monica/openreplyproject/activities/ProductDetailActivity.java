        ...
        if(transitionEnter!=null)
        {
            transitionEnter.addListener(new Transition.TransitionListener() {
                ...
                public void onTransitionStart(Transition transition) {
                    Timber.d("Monica", "getSharedElementEnterTransition - onTransitionStart");
                }
                ...
                public void onTransitionEnd(Transition transition) {
                    ...
                    Timber.d("Monica", "getSharedElementEnterTransition - onTransitionEnd");
                }
                ...
                public void onTransitionResume(Transition transition) {
                    Timber.d("Monica", "getSharedElementEnterTransition - onTransitionResume");
                }
            });
        }
//
...
//                @Override
//                public void onTransitionStart(Transition transition) {
//                    Timber.d("Monica", "getSharedElementReturnTransition - onTransitionEnd");
...
//                @Override
//                public void onTransitionResume(Transition transition) {
//                    Timber.d("Monica", "getSharedElementReturnTransition - onTransitionResume");
//                }
//            });
//        }
