package com.project.monica.openreplyproject.customrecyclerview;
...
/**
 * AutofitRecyclerView is a custom RecyclerView able to calculate the numColumns dynamically, based
 * on these inputs: column Width and RecyclerView width.
 */
